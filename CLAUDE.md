...
Library and CLI that read video file metadata with MediaInfo, ffprobe, mkvmerge, or enzyme.
...
2. Does knowit already have it? Use it again.
...
- Not lazy about: malformed backend output, non-ascii file names, errors that lose data, tests, and what the user asked for.
