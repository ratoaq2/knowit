    ...
    def __init__(self, config, suggested_path):
        ...
        super().__init__(config, {
            'general': {
                ...
                'duration': Duration('Duration', resolution=1000000, description='media duration'),
            ...
            'video': {
                ...
                'duration': Duration('Duration', resolution=1000000, description='video duration'),
            ...
            'audio': {
                ...
                'channels_count': MultiValue(AudioChannels('Channels_Original', description='audio channels count')),
                '_channels_count': MultiValue(AudioChannels('Channels', description='audio channels count'),
                                              private=True),
            ...
            'audio': {
                ...
                'channels_count': AlternativeRule('audio channels count', 'channels_count', override=True),
                'channels': AudioChannelsRule('audio channels'),
                'profile': AlternativeRule('audio codec profile', 'profile', override=True),
